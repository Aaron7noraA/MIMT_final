...
class Pframe(CompressesModel):
    ...
    def training_step(self, batch, batch_idx):
        ...
        if epoch <= phase['trainMV']:
            ...
            for frame_idx in range(1, 7):
                ...
                #elif frame_idx > 5: # cascaded loss training ; Too much frames will forbid back-propagation
                #    break
                ...
                warping_loss_list.append(warping_loss.mean().detach())
    ...
    def configure_optimizers(self):
        ...
        scheduler = optim.lr_scheduler.MultiStepLR(optimizer, lr_step, lr_gamma, verbose=True)
