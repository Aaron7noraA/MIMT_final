    ...
    def test_step(self, batch, batch_idx):
        ...
        for frame_idx in range(gop_size):
            ...
            if frame_idx != 0:
                ...
                x_hat = align.resume(m_info['x_hat'])
                ...
                if TO_VISUALIZE:
                    ...
                    save_image(mc_frame[0], self.args.save_dir + f'/{seq_name}/mc_frame/'
                                                                 f'frame_{int(frame_id_start + frame_idx)}.png')
                    save_image(x_hat[0], self.args.save_dir + f'/{seq_name}/mc_frame/'
                ...
                warp_pre_psnr = mse2psnr(self.criterion(x_hat, coding_frame).mean().item())
