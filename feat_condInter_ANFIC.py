...
from torch_compression.hub import Conv2d, ResidualBlock2
...
class Pframe(CompressesModel):
    def __init__(self, args, mo_coder, res_coder):
        ...
        self.feat_extractor_Iframe = nn.Sequential(
            ...
            nn.LeakyReLU(),
            ResidualBlock2(num_cond_features, num_cond_features, 3),
    ...
    def validation_step(self, batch, batch_idx):
        ...
        for frame_idx in range(gop_size):
            if frame_idx != 0:
                ...
                ref_frame = rec_frame
                ref_feat = self.feat_extractor_Iframe(align.align(ref_frame).clamp(0, 1))
