        ...
        if epoch <= phase['trainMV']:
            ...
            for frame_idx in range(1, 7):
                ...
                with torch.set_grad_enabled( _phase == 'ALL'): 
                    ...
                    ### additional
                    mc_reconstructed = self.mc_decode(mc)
                ...
                if self.output_nought:
                    ...
                    ### additional
                    loss += self.args.lmda * distortion.mean() + rate.mean() + 0.01 * self.args.lmda * y2_error.mean() + 0.01 * self.criterion(coding_frame, mc_reconstructed).mean()
