...
class Pframe(CompressesModel):
    ...
    def forward(self, ref_frame, coding_frame, p_order=0, visual=False, visual_prefix=''):
        ...
        reconstructed, likelihood_r, mc_hat, _, _, BDQ, self.prev_latent = self.Residual(coding_frame, 
                                                                       output=output, cond_coupling_input=mc,
    ...
    def training_step(self, batch, batch_idx):
        ...
        if epoch < phase['trainMV']:
            ...
            for frame_idx in range(1, 7):
                ...
                output = torch.zeros_like(coding_frame) if self.output_nought else mc
                reconstructed, likelihood_r, mc_hat, _, _, _, self.prev_latent = self.Residual(coding_frame, 
    ...
    def validation_step(self, batch, batch_idx):
        ...
        for frame_idx in range(gop_size):
            if frame_idx != 0:
                ...
                rec_frame, likelihoods, m_info, mc_frame, _, _, BDQ, mc_hat = self(align.align(ref_frame),
