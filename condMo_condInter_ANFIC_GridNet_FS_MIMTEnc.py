...
phase = {'trainMV': -1, 
         ...
         'trainRes_2frames': -1, 
         'trainAll_2frames': -1, 
         'trainAll_fullgop_hp': -1,#20, 
         'trainAll_fullgop_tp': -1,#50, 
         #
         'trainAll_2frames_hp': -1,#15, 
         'trainAll_2frames_tp': -1,#35, 
         #
...
if __name__ == '__main__':
    ...
    if args.restore == 'resume':
        ...
        #for k, v in checkpoint['state_dict'].items():
        #    if 'Decoder' in k and 'blocks' in k:
        #        if 's_attn' in k:
        ...
        for k, v in checkpoint['state_dict'].items():
            if k.split('.')[0] == 'Residual' and k.split('.')[1] == 'conditional_bottleneck' and 'MIMT_decoder' in k:
                continue
            else:
                new_ckpt[k] = v
